...
int main(){
    ...
    // testLaneFollower("/home/seyyit/projects/cpp-autonomous-vehicle/videos/lanefollow_100rpm_ccw.mp4");
    // testLaneFollower("/home/seyyit/projects/cpp-autonomous-vehicle/videos/res.mp4");
    // testVehicle(FileSystem::getPath("src/model/sign.onnx"),FileSystem::getPath("videos/test3.mp4"));
    // model
